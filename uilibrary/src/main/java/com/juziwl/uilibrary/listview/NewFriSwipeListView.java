 ...
 * @modify Neil
 */
public class NewFriSwipeListView extends ListView {
	...
	public NewFriSwipeListView(Context context) {
		this(context, null);
	}

	public NewFriSwipeListView(Context context, AttributeSet attrs) {
		this(context, attrs, 0);
	}

	public NewFriSwipeListView(Context context, AttributeSet attrs, int defStyle) {
		super(context, attrs, defStyle);
		TypedArray mTypedArray = context.obtainStyledAttributes(attrs,
				R.styleable.common_swipelistviewstyle);
		// 获取自定义属性和默认值
		mRightViewWidth = (int) mTypedArray.getDimension(
				R.styleable.common_swipelistviewstyle_common_right_width, 200);
		mTypedArray.recycle();
	}
