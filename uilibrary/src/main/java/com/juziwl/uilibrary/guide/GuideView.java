package com.juziwl.uilibrary.guide;
...
//     * 自定义Viewid
//     */
//    private View customGuideViewId;
...
//            this.addView(View.inflate(getContext(), R.layout.custom_view,null),new LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, ViewGroup.LayoutParams.MATCH_PARENT));
        }
    }
    ...
    private void drawBackground(Canvas canvas) {
        ...
        if (backgroundColor != 0)
            bgPaint.setColor(backgroundColor);//自己设置的背景色
        else
            bgPaint.setColor(Color.parseColor("#cc222222"));//默认的颜色

        // 绘制屏幕背景
        temp.drawRect(0, 0, temp.getWidth(), temp.getHeight(), bgPaint);

        //绘制圆弧
        RectF xiushi = new RectF();


        bgPaint.setStyle(Paint.Style.STROKE);
        bgPaint.setColor(Color.parseColor("#ffffff"));
        bgPaint.setStrokeWidth(ConvertUtils.dp2px(2,getContext()));
        xiushi.left = center[0] - ConvertUtils.dp2px(45,getContext());                              //左边
        xiushi.top = center[1] - ConvertUtils.dp2px(27,getContext());                                   //上边
        xiushi.right = center[0] + ConvertUtils.dp2px(45,getContext());                             //右边
        xiushi.bottom = center[1] + ConvertUtils.dp2px(27,getContext());
        temp.drawOval(xiushi, bgPaint);
        ...
        if (myShape != null) {
            ...
            switch (myShape) {
                case CIRCULAR://圆形
                    ...
                    break;
                case ELLIPSE://椭圆  知道园心坐标 根据ui图显示具体rect位子
                    //RectF对象
                    oval.left = center[0] -ConvertUtils.dp2px(40,getContext());                              //左边
                    oval.top = center[1] - ConvertUtils.dp2px(25,getContext());                                   //上边
                    oval.right = center[0] +ConvertUtils.dp2px(40,getContext());                             //右边
                    oval.bottom = center[1] + ConvertUtils.dp2px(25,getContext());                                //下边
