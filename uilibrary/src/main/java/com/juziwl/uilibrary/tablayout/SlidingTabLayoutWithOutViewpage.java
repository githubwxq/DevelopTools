 ...
 * @author null
 * @modify Neil
 * 滑动TabLayout,清除viewpage依赖
 */
public class SlidingTabLayoutWithOutViewpage extends HorizontalScrollView implements ViewPager.OnPageChangeListener {
    ...
    public SlidingTabLayoutWithOutViewpage(Context context) {
        this(context, null, 0);
    }

    public SlidingTabLayoutWithOutViewpage(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public SlidingTabLayoutWithOutViewpage(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void obtainAttributes(Context context, AttributeSet attrs) {
        ...
        mIndicatorMarginBottom = ta.getDimension(R.styleable.SlidingTabLayout_tl_indicator_margin_bottom, dp2px(mIndicatorStyle == STYLE_BLOCK ? 7 : 6));
