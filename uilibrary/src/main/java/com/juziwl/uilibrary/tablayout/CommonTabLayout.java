...
import com.juziwl.uilibrary.tablayout.utils.FragmentChangeManager;
...
public class CommonTabLayout extends FrameLayout implements ValueAnimator.AnimatorUpdateListener {
    ...
    private void obtainAttributes(Context context, AttributeSet attrs) {
        ...
        mTextsize = ta.getDimension(R.styleable.CommonTabLayout_tl_textsize, sp2px(15f));
        mTextSelectColor = ta.getColor(R.styleable.CommonTabLayout_tl_textSelectColor,
        ...
        mIconVisible = ta.getBoolean(R.styleable.CommonTabLayout_tl_iconVisible, false);
...
//        Log.d("AAA", "mCurrentP--->" + mCurrentP.left + "&" + mCurrentP.right);
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (mIndicatorStyle == STYLE_TRIANGLE) {
            ...
            if (mIndicatorHeight > 0) {
                if (mIndicatorCornerRadius < 0 || mIndicatorCornerRadius > mIndicatorHeight / STYLE_BLOCK) {
