...
public class HeaderOrFooter extends PullRefreshView {
    ...
    public HeaderOrFooter(@NonNull Context context, @Nullable AttributeSet attrs) {
        ...
        loadingView.setIndicatorColor(ContextCompat.getColor(context, R.color.color_333));
        tv.setTextColor(ContextCompat.getColor(context, R.color.color_333));
    }

    public HeaderOrFooter(Context context) {
        this(context, "LineScaleIndicator", ContextCompat.getColor(context, R.color.color_333), false);
    }

    public HeaderOrFooter(Context context, String animationName) {
        this(context, animationName, ContextCompat.getColor(context, R.color.color_333), false);
    }
    ...
    public HeaderOrFooter(Context context, String animationName, int color, boolean withBg) {
        ...
        if (withBg) {
            setBackgroundColor(ContextCompat.getColor(getContext(), R.color.color_333));
        }
    }
