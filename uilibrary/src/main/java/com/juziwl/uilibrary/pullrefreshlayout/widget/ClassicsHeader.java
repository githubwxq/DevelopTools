...
import com.juziwl.uilibrary.pullrefreshlayout.widget.pathview.PathsDrawable;
...
import static com.juziwl.uilibrary.pullrefreshlayout.PRLCommonUtils.dipToPx;
...
public class ClassicsHeader extends NestedRelativeLayout implements PullRefreshLayout.OnPullListener {
    ...
    public ClassicsHeader(Context context, AttributeSet attrs) {
        ...
        mHeaderText.setTextColor(ContextCompat.getColor(getContext(), R.color.color_666));
        mArrowDrawable.parserColors(0xff666666);
        mLastUpdateText.setTextColor(ContextCompat.getColor(getContext(), R.color.color_999));
        mProgressDrawable.setColor(ContextCompat.getColor(getContext(), R.color.color_666));
    }
    ...
    protected void initView(Context context, AttributeSet attrs) {
        ...
        mHeaderText.setTextColor(ContextCompat.getColor(getContext(), R.color.white));
        mHeaderText.setTextSize(16);

        mLastUpdateText = new TextView(context);
        mLastUpdateText.setTextColor(ContextCompat.getColor(getContext(), R.color.color_333));
        ...
        RelativeLayout.LayoutParams lpProgress = new RelativeLayout.LayoutParams(dipToPx(getContext(), 20), dipToPx(getContext(), 20));
        ...
        mProgressDrawable.setColor(ContextCompat.getColor(getContext(), R.color.white));
