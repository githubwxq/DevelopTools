package com.juziwl.uilibrary.rlayout.helper;
...
import com.juziwl.uilibrary.rlayout.shadow.ShadowDrawable;
...
public class RBaseHelper<T extends View> {
    ...
    private void setup() {
        ...
        states[5] = new int[]{android.R.attr.state_selected};//select
        states[6] = new int[]{-android.R.attr.state_selected};//unselect

        //unable,focused,pressed,checked,normal
        mStateBackground.addState(states[0], mBackgroundUnableBmp == null ? mBackgroundUnable : mBackgroundUnableBmp);
        if (mHasPressedBgColor || mHasCheckedBgColor) {
        ...
        if (mHasSelectedBgColor) {
            mStateBackground.addState(states[5], mBackgroundSelectedBmp == null ? mBackgroundSelected : mBackgroundSelectedBmp);
            mStateBackground.addState(states[6], mBackgroundNormalBmp == null ? mBackgroundNormal : mBackgroundNormalBmp);
        }
...
//        mBackgroundSelected.setColor(Color.GREEN);
     ...
     * 更新drawable背景时时候刷新
     */
    public void refreshStateListDrawable() {
    ...
    private void setBorderSelected() {
        mBackgroundChecked.setStroke(mBorderWidthSelected, mBorderColorSelected, mBorderDashWidth, mBorderDashGap);
        setBackgroundState();
    }
