...
public class PieChartView extends View {
     ...
     * 标记线长度
     */
    private float markerLineLength = 40f;
...
//
//pieceDataHolders.add(new PieChartView.PieceDataHolder(10,0xFF77CCAA, "语文10min"));
//        pieceDataHolders.add(new PieChartView.PieceDataHolder(20, 0xFF11AA33, "数学20min"));
//        pieceDataHolders.add(new PieChartView.PieceDataHolder(30, Color.GRAY, "英语30min"));
