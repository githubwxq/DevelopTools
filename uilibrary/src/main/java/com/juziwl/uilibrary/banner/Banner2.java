...
import com.juziwl.uilibrary.banner.listener.OnBannerClickListener;
...
import com.juziwl.uilibrary.banner.view.BannerViewPager;
...
//
//    app:indicator_drawable_selected="@color/common_white"
//    app:indicator_drawable_unselected="@color/common_gray3"
    ...
    private void initView(Context context, AttributeSet attrs) {
        imageViews.clear();
        View view = LayoutInflater.from(context).inflate(R.layout.banner2, this, true);
        viewPager = (BannerViewPager) view.findViewById(R.id.bannerViewPager);
        //5dp的间距
        int dptopx= (int)(context.getResources().getDisplayMetrics().density*5+0.5f);
        viewPager.setPageMargin(dptopx);
    ...
    public Banner2 setBannerAnimation(Class<? extends PageTransformer> transformer) {
        try {
     ...
     * @return Banner
     */
    public Banner2 setPageTransformer(boolean reverseDrawingOrder, PageTransformer transformer) {
    ...
    public Banner2 setImages(List<?> imageUrls) {
    ...
    private void setTitleStyleUI() {
        ...
        if (titleBackground != BannerConfig.TITLE_BACKGROUND) {
