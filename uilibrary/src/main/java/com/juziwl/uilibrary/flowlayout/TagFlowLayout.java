...
public class TagFlowLayout extends FlowLayout
    ...
    private int itemMarginleft =0;
    private int itemMarginTop =0;
    private int itemMarginRight =0;
    ...
    public TagFlowLayout(Context context, AttributeSet attrs, int defStyle) {
        ...
        itemMarginleft=   ta.getDimensionPixelOffset(R.styleable.TagFlowLayout_TagFlowLayout_left_margin,dip2px(getContext(),0));
        itemMarginTop=   ta.getDimensionPixelOffset(R.styleable.TagFlowLayout_TagFlowLayout_top_margin,dip2px(getContext(),0));
        itemMarginRight=   ta.getDimensionPixelOffset(R.styleable.TagFlowLayout_TagFlowLayout_right_margin,dip2px(getContext(),0));
        itemMarginBottom=   ta.getDimensionPixelOffset(R.styleable.TagFlowLayout_TagFlowLayout_bottom_margin,dip2px(getContext(),0));
