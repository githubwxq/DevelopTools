...
//    verTv.setTextList(data);//加入显示内容,集合类型
//    verTv.setText(getResources().getDimensionPixelSize(R.dimen.y24), 5, Color.WHITE);//设置属性,具体跟踪源码
//    verTv.setTextStillTime(3000);//设置停留时长间隔
//    verTv.setAnimTime(300);//设置进入和退出的时间间隔
//    verTv.startAutoScroll();
//    verTv.stopautoscroll
}
