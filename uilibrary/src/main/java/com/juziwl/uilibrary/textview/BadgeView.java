   ...
   private Handler mHandler = new Handler() {
    ...
    private void applyTo(View target) {
        ...
        if (target instanceof TabWidget) {
            ...
            container.addView(target, new FrameLayout.LayoutParams(LayoutParams.WRAP_CONTENT, LayoutParams.WRAP_CONTENT, Gravity.CENTER));

            this.setVisibility(View.GONE);
            container.addView(this, new FrameLayout.LayoutParams(LayoutParams.WRAP_CONTENT, LayoutParams.WRAP_CONTENT, Gravity.CENTER));
...
//    public void hide(boolean animate, int animResouse) {
//        if (animate) {
//            setBackgroundResource(+R.anim.badgeview);
...
//            }
//            mHandler.sendEmptyMessageDelayed(1,durationTime);
//        }
//    }
...
//                if (BaseActivity.isTouchable) {
//                    if (mClickListener != null) {
//                        BaseActivity.isTouchable = false;
...
//                    mClickListener.onMove(event.getRawX(), event.getRawY() - Utils.getTopBarHeight((Activity) context));
//                }
//                break;
