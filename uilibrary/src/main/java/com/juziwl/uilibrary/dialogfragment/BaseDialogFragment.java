package com.juziwl.uilibrary.dialogfragment;
...
// 使用
//
//public class DialogSexChoose extends BaseDialogFrag implements View.OnClickListener {
//
...
//
//    @Override
//    public void convertView(ViewHolder holder, BaseDialogFrag dialog) {
//
//    }
//
//    @Override
...
//
//
//DialogSexChoose dialogSexChoose = new DialogSexChoose();
//                dialogSexChoose.setOnClickListener(new View.OnClickListener() {
//@Override
//public void onClick(View view) {
//        switch (view.getId()) {
//
...
//        }
//        });
//        dialogSexChoose.setAnimStyle(R.style.Animation_Bottom_Dialog)
//        .setDimAmout(0.3f)
//        .setShowBottom(true)
