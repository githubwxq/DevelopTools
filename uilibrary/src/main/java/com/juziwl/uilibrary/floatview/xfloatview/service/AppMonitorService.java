package com.juziwl.uilibrary.floatview.xfloatview.service;
...
import com.juziwl.uilibrary.floatview.xfloatview.AppSwitchView;
...
public class AppMonitorService extends Service {
    ...
    public void onCreate() {
        ...
        startForeground(1000, builder.setContentTitle("应用监测")
                ...
                .setSmallIcon(R.mipmap.right_arrow)
                .setAutoCancel(false)
                .setOngoing(true)
                .build());
    }
    ...
    private void init(int uid, String appName, String appPackageName) {
        ...
        if (mAppMonitor == null) {
            mAppMonitor = new AppMonitor(this, (appName1, packageName) -> {
                if (mAppSwitchView != null) {
                    mAppSwitchView.updateAppInfo("123123123", "3413412313123");
                }
            });
