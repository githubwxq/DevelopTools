...
//    android:layout_marginTop="6dp"
    ...
    public GrideItemDecorationForKeyBoard(int color) {
        mDivider = new ColorDrawable(color);
    }


    public GrideItemDecorationForKeyBoard(Context context) {
        this(Color.parseColor("#E8E8E8"));
        mContext=context;
        horizonWidth= dp2px(12,context);
        verticalWidth= dp2px(6,context);
    }
