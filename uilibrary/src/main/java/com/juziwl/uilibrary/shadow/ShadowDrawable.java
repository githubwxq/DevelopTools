package com.juziwl.uilibrary.shadow;
...
public class ShadowDrawable extends Drawable {
    ...
    public static ShadowDrawable fromAttributeSet(Context context, AttributeSet attrs) {
        ...
        int shadowRadius = typedArray.getDimensionPixelSize(R.styleable.ShadowDrawable_sd_shadowRadius,0);
        ...
        int shapeRadius = typedArray.getDimensionPixelSize(R.styleable.ShadowDrawable_sd_shapeRadius,0);
        ...
        int bgColor = typedArray.getColor(R.styleable.ShadowDrawable_sd_bgColor, context.getResources().getColor(R.color.white));
