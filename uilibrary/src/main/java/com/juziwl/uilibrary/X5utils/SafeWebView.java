...
//        我加的
    ...
    private void safeSetting() {
        ...
        getSettings().setUseWideViewPort(true);//使Webview任意比例的缩放,而当设置为false时， web视图都有一个视口局限于自己的尺寸(比如要将web视图在视区50px*50px相同的大小)
...
//        getSettings().setSavePassword(true);
        ...
        getSettings().setJavaScriptEnabled(true); //支持JavaScript脚本
        getSettings().setGeolocationEnabled(true);//启用地理定位
        getSettings().setGeolocationDatabasePath("/system/data/org.itri.html5webView/databases/");//设置定位的数据库路径
