...
//        private static final PayOrder pay = new PayOrder();
//    }
//
//    private PayOrder() {
//    }
//
//    public static final PayOrder getInstance() {
...
//                        onPayListener.paySuccess(ordernumber);
//                    } else {
...
////                            ordernumber = json.optString("orderId");
////                            if (payType == ALIPAY) {
////                                ZFBPayOrder.getInstance().pay(context, handler, payInfo, onAccountPayListener);
////                            }
////                            if (payType == WEIXIN) {
...
////                                WeiXinPayOrder.getInstance().pay(context, payInfo, key);
////                            }
////                            if (payType == ACCOUNT) {
////                                if (onAccountPayListener != null) {
////                                    if (!TextUtils.isEmpty(key) || !TextUtils.isEmpty(message)) {
////                                        onAccountPayListener.paySuccess(ordernumber);
////                                    } else {
