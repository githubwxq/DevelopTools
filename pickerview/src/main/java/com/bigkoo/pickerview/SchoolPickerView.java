...
import com.bigkoo.pickerview.view.SchoolWheelOptions;
...
public class SchoolPickerView extends BasePickerView implements View.OnClickListener{
    private SchoolWheelOptions wheelOptions;
    ...
    //构造方法
    public SchoolPickerView(Builder builder) {
    ...
    private void initView(Context context) {
        ...
        wheelOptions = new SchoolWheelOptions(optionsPicker, linkage);
    ...
    public void setPicker(List<Grade> optionsItems) {
        wheelOptions.setPicker(optionsItems);
        SetCurrentItems();
    }

    //不联动情况下调用
    public void setNPicker(List<Grade> optionsItems) {

        wheelOptions.setNPicker(optionsItems);
        SetCurrentItems();
    }
    ...
    @Override
    public boolean isContainerBgDark() {
        return isDark;
    }

    //建造器
    public static class Builder {
        private int layoutRes = R.layout.pickerview_options_two_object;
        private CustomListener customListener;
         ...
         * @return
         */
        public Builder isContainerBgDark(boolean isDark) {
            this.isDark = isDark;
            return this;
        }

        public SchoolPickerView build() {
            return new SchoolPickerView(this);
        }
    }
