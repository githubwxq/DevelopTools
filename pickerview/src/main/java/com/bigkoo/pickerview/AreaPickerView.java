...
public class AreaPickerView extends BasePickerView implements View.OnClickListener {
    private AreaWheelOptions wheelOptions;
    ...
    //构造方法
    public AreaPickerView(Builder builder) {
    ...
    private void initView(Context context) {
        ...
        wheelOptions = new AreaWheelOptions(optionsPicker, linkage);
    ...
    public void setPicker(List<Province> optionsItems) {
        wheelOptions.setPicker(optionsItems);
        SetCurrentItems();
    }

    //不联动情况下调用
    public void setNPicker(List<Province> optionsItems) {
    ...
    public static class Builder {
        ...
        public AreaPickerView build() {
            return new AreaPickerView(this);
        }
    }
