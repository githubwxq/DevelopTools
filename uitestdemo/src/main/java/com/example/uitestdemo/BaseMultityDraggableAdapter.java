 ...
 */
public abstract class BaseMultityDraggableAdapter<T, K extends BaseViewHolder> extends BaseQuickAdapter<T, K> {
    ...
    public BaseMultityDraggableAdapter(List<T> data) {
        super(data);
    }

    public BaseMultityDraggableAdapter(int layoutResId, List<T> data) {
