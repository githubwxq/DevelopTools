...
//        //配置
        ...
        build.setThreadCount(3) //线程数量
                ...
                .setLoadingImage(R.mipmap.common_falseimg)
                .setFaildImage(R.mipmap.common_falseimg);
        ...
        List<String> list = Arrays.asList(imageThumbUrls);
        ;
//        list.add("11");
//        list.add("11");
//        list.add("11");
...
//        recycle.setItemAnimator(new SlideInDownAnimator());
        recycle.setAdapter(new CommonRecyclerAdapter<String>(RecycleViewTestActivity.this, R.layout.item_change_clarity, list) {
            @Override
            public void onUpdate(BaseAdapterHelper helper, String item, int position) {
                ImageView imageView = helper.getView(R.id.iv_image);
//                iv_image
                imageLoader.displayImage(imageView, item);
