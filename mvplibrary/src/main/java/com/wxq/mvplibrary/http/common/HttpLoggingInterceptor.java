package com.wxq.mvplibrary.http.common;
...
public class HttpLoggingInterceptor implements Interceptor {
    ...
    private void bodyToString(Request request) {
        try {
            ...
            /** 是json并且加密的话 解密的操作 */
//            if (isJson(body.contentType()) && Api.IS_HTTP_ENCRYPT) {
//                String transId = request.header("TRANSID");
//                if (transId != null && transId.length() >= Api.AES_KEY_LENGTH) {
//                    String key = transId.substring(transId.length() - Api.AES_KEY_LENGTH);
//                    log("\tbody:" + Aes.aesDecrypt(requestBody, key));
//                }
//            } else {
