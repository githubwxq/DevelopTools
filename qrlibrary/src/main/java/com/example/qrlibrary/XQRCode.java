...
import com.example.qrlibrary.camera.AutoFocusCallback;
import com.example.qrlibrary.camera.CameraManager;
import com.example.qrlibrary.logs.QCLog;
import com.example.qrlibrary.ui.CaptureActivity;
import com.example.qrlibrary.ui.CaptureFragment;
import com.example.qrlibrary.util.QRCodeAnalyzeUtils;
import com.example.qrlibrary.util.QRCodeProduceUtils;
import com.google.zxing.Result;
import java.util.List;

import static com.example.qrlibrary.util.QRCodeProduceUtils.QRCODE_BITMAP_MAX_SIZE;
...
public class XQRCode {
     ...
     * 默认二维码扫描的activity启动
     */
    public static final String ACTION_DEFAULT_CAPTURE = "com.example.qrlibrary.ui.CaptureActivity";
