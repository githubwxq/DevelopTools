...
package com.juziwl.ijkplayerlib.controller;
...
import com.juziwl.ijkplayerlib.R;
...
//    private final AccessibilityManager mAccessibilityManager;
    ...
    public CustomMediaController(Context context, AttributeSet attrs) {
        ...
        mFromXml = true;
//        mAccessibilityManager = getAccessibilityManagerInstance(context);
    }
...
//        mWindow = getPhoneWindowInstance(mContext);
...
//                        mWindowManager.updateViewLayout(mDecor, mDecorLayoutParams);
    ...
    public void setAnchorView(View view) {
        ...
        if (view instanceof RelativeLayout || view instanceof FrameLayout) {
            ...
            throw new IllegalStateException("anchorView must is RelativeLayout or FrameLayout");
        }
    }
    ...
    protected View makeControllerView() {
        mRoot = LayoutInflater.from(mContext).inflate(R.layout.layout_new_media_controller, this);
        initControllerView(mRoot);
        return mRoot;
    }
    ...
    private void initControllerView(View v) {
        ...
        v.findViewById(R.id.ll_top).getLayoutParams().height = topHeight;
...
//            mWindowManager.addView(mDecor, mDecorLayoutParams);
        ...
        if (timeout != 0) {
//        if (timeout != 0 && mAccessibilityManager != null && !mAccessibilityManager.isTouchExplorationEnabled()) {
...
//                mWindowManager.removeView(mDecor);
    ...
    private void updatePausePlay() {
        ...
        if (mPlayer.isPlaying()) {
            mPauseButton.setImageResource(R.drawable.easy_media_back_pause);
            mPauseButton.setContentDescription(mPauseDescription);
        } else {
            mPauseButton.setImageResource(R.drawable.easy_media_back_play);
