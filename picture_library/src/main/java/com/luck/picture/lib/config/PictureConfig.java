...
public final class PictureConfig {
    ...
    public static final long DAFAULT_VIDEO_DURATION = 15_000L;
    public static final long DAFAULT_VIDEO_SIZE = 20 * 1024 * 1024L;
    public static final long DEFAULT_IMAGE_SIZE = 10 * 1024 * 1024L;

    public static final String ACTION_SELECT_FINISH = "action_com.luck.picture.lib.config.PictureConfig_select_finish";
}
