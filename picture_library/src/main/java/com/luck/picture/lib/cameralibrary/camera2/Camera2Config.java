...
public class Camera2Config {
    ...
    public static int RECORD_PROGRESS_VIEW_COLOR = R.color.blue;//进度条颜色，默认蓝色
    public static int PREVIEW_MAX_HEIGHT = 1920;//最大高度预览尺寸，默认大于1000的第一个
    public static String PATH_SAVE_VIDEO= GlobalContent.VIDEOPATH;//小视频存放地址，不设置的话默认在根目录的Camera2文件夹
    public static String PATH_SAVE_PIC= GlobalContent.imgPath;//图片保存地址，不设置的话默认在根目录的Camera2文件夹
