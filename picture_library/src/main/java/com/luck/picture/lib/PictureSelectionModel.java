...
public class PictureSelectionModel {
    ...
    public PictureSelectionModel isJudeImageSize(boolean isJudeImageSize) {
        selectionConfig.isJudgeImageSize = isJudeImageSize;
        return this;
    }
     ...
     * @return
     */
    public PictureSelectionModel setmaxImageSize(long maxImageSize) {
        selectionConfig.maxImageSize = maxImageSize;
        return this;
    }
    ...
    /**
     * @param outputCameraPath Video save path
     * @return
     */
    public PictureSelectionModel setOutputVideoPath(String outputCameraPath) {
        selectionConfig.outputVideoPath = outputCameraPath;
        return this;
    }
    ...
    /**
     * @param loginType 传入Global.loginType
     */
    public PictureSelectionModel setStyle(int loginType) {
        if (loginType == 2) {
            selectionConfig.themeStyleId = R.style.picture_default_style_tea;
        } else {
            selectionConfig.themeStyleId = R.style.picture_default_style_par;
        }
        return this;
    }
    ...
    public PictureSelectionModel isSetTheme(boolean isSetTheme) {
        selectionConfig.isSetTheme = isSetTheme;
        return this;
    }

    public PictureSelectionModel setClassName(String... classNames) {
        selectionConfig.classNames = classNames;
        return this;
    }

    public PictureSelectionModel videoDuration(long videoDuration) {
        selectionConfig.videoDuration = videoDuration;
        return this;
    }

    public PictureSelectionModel videoSize(long videoSize) {
        selectionConfig.videoSize = videoSize;
        return this;
    }
...
//            activity.overridePendingTransition(R.anim.a5, 0);
    ...
    public void externalPicturePreview(int position, List<LocalMedia> medias) {
        if (!DoubleUtils.isFastDoubleClick()) {
            Activity activity = selector.getActivity();
            Intent intent = new Intent(activity, PictureExternalPreviewActivity.class);
...
//            getActivity().overridePendingTransition(R.anim.a5, 0);
    ...
    public void externalPictureAudio(String path) {
        if (!DoubleUtils.isFastDoubleClick()) {
            Activity activity = selector.getActivity();
            Intent intent = new Intent(activity, PicturePlayAudioActivity.class);
